export default function Footer() {
  return (
    <>
      ...
      <section className="bg-sand">
        <div className="grid md:grid-cols-3">
          <div className="p-12 flex flex-col gap-4">
            <p className="text-xs font-semibold tracking-widest uppercase text-rose">Atrašanās vieta</p>
            <h3 className="font-serif text-3xl text-brown">Ruses iela 6-1<br /><em className="text-rose">Rīga, LV-1029</em></h3>
          ...
          <div className="md:col-span-2">
            <iframe
              ...
              className="w-full h-full min-h-[320px] border-0" allowFullScreen loading="lazy"
      ...
      {/* Footer */}
      <footer className="bg-brown pt-14 pb-0">
        <div className="max-w-5xl mx-auto px-6 pb-12 grid grid-cols-1 md:grid-cols-3 gap-10">
          <div>
            <p className="font-serif text-xl text-white mb-3">Marina <em className="text-rose-lt">BeautyRoom</em></p>
            <p className="text-white/35 text-sm leading-loose">Vaksācija Zolītūde / Imanta<br/>Ruses iela 6-1, Rīga LV-1029<br/>Atvērts 24 stundas katru dienu</p>
          </div>
          <div>
      ...
      <a href="tel:+37129818158"
        className="md:hidden fixed bottom-6 right-5 w-13 h-13 bg-rose hover:bg-rose-dk text-white rounded-full flex items-center justify-center shadow-lg z-40 transition-all hover:scale-105"
        aria-label="Zvanīt">
